<?php
// sidebar_admin.php — premium left navigation sidebar (Admin role)
// Design system v5: Linear / Fluent / Zoho People inspired, light mode.
$current_page = basename($_SERVER['PHP_SELF']);

$nav_groups = [
    'My Space' => [
        ['admin_dashboard.php','admin_dashboard.php','grid','Dashboard'],
        ['admin_profile.php','admin_profile.php','user','My Profile'],
    ],
    'Employees' => [
    ...
    'Operations' => [
        ['admin_attendance.php','admin_attendance.php','clock','Attendance'],
        ['shifts.php','shifts.php','clock','Shift Management'],
        ['admin_leaves.php','admin_leaves.php','leaf','Leaves'],
        ...
        ['leave_types.php','leave_types.php','tag','Leave Types'],
        ['admin_holidays.php','admin_holidays.php','flag','Holiday Calendar'],
    ...
    'Company' => [
        ...
        ['admin_rules.php','admin_rules.php','shield','Rules & Regulations'],
        ['employee_report.php','employee_report.php','bar-chart','Employee Report'],
        ['admin_activity_log.php','admin_activity_log.php','clock','Activity Log'],
    ],
];

// One shared inline-icon renderer (also used by topbar_admin.php, which is
// always included right after this file on every admin page).
...
<script>
(function(){
    // Instant visual feedback on navigation clicks (Linear/Notion-style top bar).
    // This doesn't make the server respond faster — it just shows the user
    // immediately that their click registered, instead of a stark blank
    // white gap while the PHP page runs its DB queries.
    ...
    // Note: intentionally NOT using a 'beforeunload' listener here — it
    // silently disables the browser's back/forward cache on many pages,
    // which would make navigation *slower*, working against the whole
    // point of this bar.
})();
</script>
