...
$all_notif = mysqli_query($conn, "SELECT emp_name, leave_type, from_date, to_date, reason, type, is_read FROM notifications WHERE for_role='admin' ORDER BY created_at DESC LIMIT 15");
