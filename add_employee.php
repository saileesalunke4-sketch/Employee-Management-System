...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // Step 1 - users table mein insert karo
    ...
    if(mysqli_query($conn, $user_query)){
        ...
        // Step 2 - employees table mein insert karo
        $emp_query = "INSERT INTO employees 
                      (user_id, first_name, last_name, contact, designation, blood_group, dob, religion, address) 
                      VALUES 
                      ('$user_id','$first_name','$last_name','$contact','$designation','$blood_group','$dob','$religion','$address')";
...
<div class="dashboard">
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="#" class="nav-item">Leaves</a>
