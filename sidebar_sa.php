<?php
// sidebar_sa.php — premium left navigation sidebar (Super Admin role)
$current_page = basename($_SERVER['PHP_SELF']);

$nav_groups = [
    'My Space' => [
        ['super_admin_dashboard.php','super_admin_dashboard.php','grid','Dashboard'],
        ['sa_profile.php','sa_profile.php','user','My Profile'],
    ],
    'Employees' => [
        ['all_employees.php','all_employees.php','users','All Employees'],
...
// Shared inline-icon renderer (also used by topbar_sa.php, which is
// always included right after this file on every super-admin page).
