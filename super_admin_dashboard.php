            ...
            <div class="notif-dropdown" id="notifDropdown">
                ...
                <?php
                    ...
                    while($n = mysqli_fetch_assoc($all_notif)){
                        ...
                        echo "
                        <div class='notif-item {$is_new}'>
                            <div class='notif-icon'>&#128203;</div>
                            <div class='notif-text'>
                                <strong>{$n['emp_name']}</strong> applied for
...
<?php
    // All employees attendance data per month
    ...
    // All employees leave data per month
...
// Open or close the bell dropdown
